...
const Contact = () => {
    ...
    formData.append("access_key","41830a67-e48e-403d-8f2e-8e0bbb20171f")
  ...
  return (
    <div className='contact'>
        <div className="contact-col">
            ...
            <ul>
                <li><img src={mail_icon} alt="" /> myGurukulUniversity@gmail.com</li>
                <li><img src={phone_icon} alt="" /> 02222707822</li>
                <li><img src={location_icon} alt="" /> Gurukul University<br /> Mahatma Gandhi Rd, Mumbai <br />Maharashtra, 400032</li>
                <li></li>
            </ul>
        </div>
        <div className="contact-col">
            <form onSubmit={onSubmit}>
                ...
                <input type="tel" name='phone' placeholder='Enter you mobile number' required/><br />
